...
\caption{Layout}Constant k is predefined max length of sublist. White block is head block reference stored in head pointer block(Figure 1) and yellow block is linked sublist inode block.\\[0.5em] \hrule
\end{figure}
